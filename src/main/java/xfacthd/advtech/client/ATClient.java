...
public class ATClient
{
    ...
    public static void onClientSetup(final FMLClientSetupEvent event)
    {
        ...
        RenderTypeLookup.setRenderLayer(ATContent.blockCharger, RenderType.getCutoutMipped());
        ...
        DeferredWorkQueue.runLater(() ->
        {
            ...
            ScreenManager.registerFactory(ContainerTypes.containerTypeCharger, ScreenCharger::new);
