...
public class ScreenFertilizer extends ScreenInventoryMachine<ContainerMenuFertilizer>
{
    private static final ResourceLocation BACKGROUND = background("fertilizer");

    public ScreenFertilizer(ContainerMenuFertilizer container, Inventory inventory, Component title)
    {
