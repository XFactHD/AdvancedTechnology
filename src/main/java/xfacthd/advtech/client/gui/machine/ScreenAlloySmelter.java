...
public class ScreenAlloySmelter extends ScreenProducer<ContainerAlloySmelter>
{
    ...
    public ScreenAlloySmelter(ContainerAlloySmelter container, PlayerInventory inventory, ITextComponent title)
    {
