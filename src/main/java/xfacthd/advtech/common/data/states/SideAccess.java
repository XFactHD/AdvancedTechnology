...
public enum SideAccess implements StringRepresentable
{
    NONE         (0x7C7E7E),
    INPUT_ALL    (0x0000FF),
    INPUT_MAIN   (0xA700FF),
    ...
    /**
     * Wether this SideAccess overrules the SideAccess passed in
     */
    ...
    public static SideAccess byId(int id) { return values()[id]; }
}