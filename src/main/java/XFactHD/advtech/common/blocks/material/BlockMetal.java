...
public class BlockMetal extends BlockBase
{
    public BlockMetal()
    {
        super("blockMetal", Material.IRON, AdvancedTechnology.creativeTab, ItemBlockBase.class, EnumType.getAsStringArray());
        setHardness(5.0F);
        setResistance(10.0F);
    ...
    {
        return new BlockStateContainer(this, PropertyHolder.METAL_TYPE);
    }

    @Override
    public IBlockState getStateFromMeta(int meta)
    {
        return getDefaultState().withProperty(PropertyHolder.METAL_TYPE, EnumType.values()[meta]);
    }

    @Override
    public int getMetaFromState(IBlockState state)
    {
        return state.getValue(PropertyHolder.METAL_TYPE).ordinal();
    }
    ...
    public enum EnumType implements IStringSerializable
    {
        ...
        BRONZE("blockBronze"),
        NICKEL("blockNickel"),
        LITHIUM("blockLithium"),
        CADMIUM("blockCadmium"),
        ZINC("blockZinc"),
        PLATINUM("blockPlatinum"),
        TUNGSTEN("blockTungsten"),
        NEODYMIUM("blockNeodymium");
